...
// 拆分出的 builder 模块族（纯函数迁移，逻辑不变）
import {
  CONFIG_EXTS, ENTRY_BASENAMES, SERVICE_NAME_RE, isEntryFile, componentKind, pascalCaseName,
  moduleLayerOf, dirOf, createGoImportResolver, isTestFile, uniqueId, findCycles,
